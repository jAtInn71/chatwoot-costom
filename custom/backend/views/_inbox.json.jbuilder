...
json.input_bar_bg_color resource.channel.try(:input_bar_bg_color)
json.input_bar_text_color resource.channel.try(:input_bar_text_color)
json.header_bg_color resource.channel.try(:header_bg_color)
json.header_text_color resource.channel.try(:header_text_color)
