;(function(){
  ...
  // ── 2. onmessage — no protection needed ─────────────────────────────────
  // Chatwoot SDK uses window.onmessage for iframe ↔ parent communication.
  // Leave it untouched so the widget can initialize properly.
