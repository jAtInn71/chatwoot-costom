  ...
  events: {
    loaded: message => {
      ...
      IFrameHelper.sendMessage('config-set', {
        ...
        availableMessage: window.$chatwoot.availableMessage || (message.config.channelConfig && message.config.channelConfig.availableMessage) || '',
        unavailableMessage: window.$chatwoot.unavailableMessage || (message.config.channelConfig && message.config.channelConfig.unavailableMessage) || '',
